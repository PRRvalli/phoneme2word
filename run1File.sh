fileIn=$1;
fileOut=$2;
cd /home/srinivasa/kaldi-trunk/egs/chiru/FA_wordTrans/
...
DIR3b="/home/srinivasa/kaldi-trunk/egs/chiru/FA_wordTrans/data"
lang="/home/srinivasa/kaldi-trunk/egs/chiru/FA_wordTrans/data/lang"
mfccdir=mfcc
...
DIR="/home/srinivasa/kaldi-trunk";
DIR1b="/home/srinivasa/kaldi-trunk/egs/chiru/FA_wordTrans/exp";
...
$DIR/src/featbin/compute-mfcc-feats --verbose=2 --config=/home/srinivasa/kaldi-trunk/egs/chiru/FA_wordTrans/conf/mfcc.conf scp,p:$DIR3b/wav.scp ark:- | $DIR/src/featbin/copy-feats --compress=true ark:- ark,scp:$DIR3b/mfcc_test.ark,$DIR3b/feats.scp
